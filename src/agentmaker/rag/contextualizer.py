...
# The default prompt is now provided by the central registry agentmaker.prompts (single source of truth); this constant is a convenience alias snapshotted at import time (does not follow overrides).
