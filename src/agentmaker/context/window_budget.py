...
class WindowBudgetConfig:
    ...
    Attributes:
        ...
        rag_ratio: The fraction of the "allocatable balance" assigned to the retrieval block
            (memory/RAG); the trajectory receives the remainder, so the two allocations cannot
            sum past the window.
    """
