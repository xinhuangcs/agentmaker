...
packages the state, and returns an internal Interrupt; the outer run boundary exposes it through an interrupted
RunResult, and the caller later calls resume(decision) to continue.
"""
