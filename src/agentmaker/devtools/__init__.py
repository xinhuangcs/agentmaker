...
package. The native observability pipeline remains Harness emits events -> Tracer redacts -> exporters
sink them, independently of whether this package is imported.
